 ...
 */
    ...
    'mod_usrgr_TextAreaFieldLabel' => 'Приклад багатосторінкового поля',
    'mod_usrgr_IntegerFieldLabel' => 'Приклад числового поля',
    'mod_usrgr_ToggleFieldLabel' => 'Перемикач',
    ...
    'mod_usrgr_AddNewUsersGroup' => 'Створити телефонну групу',
    ...
    'mod_usrgr_SelectUserGroup' => 'Виберіть телефонну групу для співробітника',
    'mod_usrgr_isolatePickUp' => 'Ізолювати функцію перехоплення (Pickup)',
    'BreadcrumbModuleUsersGroupsModify' => 'Налаштування телефонної групи',
